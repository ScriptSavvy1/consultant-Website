                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/70 hover:bg-primary hover:text-secondary transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-5 text-white/70">
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <span className="pt-2">+252-61-000-0000</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-primary shrink-0 mt-0.5">
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                ...
                                <span className="pt-2">Dhiiranegroup@gmail.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
