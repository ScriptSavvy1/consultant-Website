...
const cards = [
    {
        ...
        label: "Our Mission",
        title: "Empower institutions through locally informed solutions",
        description:
    ...
    },
    {
        ...
        label: "Our Vision",
        title: "A stable and prosperous East Africa",
        description:
        ...
        <section className="py-20 lg:py-28 bg-bg-silver">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    {/* Right Column: Mission / Vision / Value — Elevated Dark Cards */}
                    <div className="relative">
                        <div className="rounded-3xl overflow-hidden bg-secondary p-[1px]"
                            style={{ background: "linear-gradient(135deg, rgba(236,171,43,0.2), rgba(10,37,64,1), rgba(236,171,43,0.1))" }}>
                            <div className="bg-secondary rounded-3xl">
                                <div className="grid gap-[1px]" style={{ background: "rgba(255,255,255,0.06)" }}>
                                    {cards.map((card) => (
                                        <div
                                            key={card.label}
                                            className="bg-secondary p-8 lg:p-10 first:rounded-t-3xl last:rounded-b-3xl group hover:bg-secondary/90 transition-colors duration-300"
                                        >
