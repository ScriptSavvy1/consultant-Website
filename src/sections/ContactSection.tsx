                        ...
                        >
                            ...
                            {status === "success" && (
                                <div className="mt-6 p-4 rounded-xl bg-green-50 border border-green-200 flex items-center gap-3">
                                    ...
                                    <p className="text-green-800 text-sm font-medium">Thank you! Your message has been sent. We&apos;ll get back to you shortly.</p>
                                </div>
                            )}
                            ...
                            <button
                                ...
                                className="mt-8 w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-gray-900 to-primary text-white px-8 py-4 rounded-xl text-base font-bold shadow-[0_4px_14px_rgba(236,171,43,0.35)] hover:shadow-[0_8px_25px_rgba(236,171,43,0.5)] hover:-translate-y-1 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-[0_4px_14px_rgba(236,171,43,0.35)]"
                            >
                                {status === "loading" ? (
                                    <>
