        ...
        <section className="py-20 lg:py-28 bg-bg-silver">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg max-w-none space-y-8 text-text-body">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">2. Services Description</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">3. Intellectual Property</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">4. Use of Website</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">5. Contact Form Submissions</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">6. Disclaimer of Warranties</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">7. Limitation of Liability</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">8. External Links</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">9. Modifications</h2>
                        <p className="leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-secondary mb-3">10. Governing Law</h2>
                        <p className="leading-relaxed">
